...
{
    // https://docs.microsoft.com/windows/desktop/api/winbase/nf-winbase-getenvironmentvariable
    //
    ...
    public string? GetDesktopNoCache()
    {
        ...
        StringBuilder blob = new(128); // A somewhat reasonable default size
        int requiredSize = Desktop.GetEnvironmentVariable(variable, blob, blob.Capacity);
    ...
    public unsafe string? GetCoreFixed()
    {
        ...
        ValueStringBuilder buffer = new(stack);
